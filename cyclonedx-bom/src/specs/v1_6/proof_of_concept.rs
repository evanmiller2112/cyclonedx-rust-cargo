...
pub(crate) struct ProofOfConcept {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    supporting_material: Option<Vec<crate::specs::v1_6::attachment::Attachment>>,
}
...
impl FromXml for ProofOfConcept {
        ...
        Self: Sized,
    {
        ...
        let mut supporting_material: Option<Vec<crate::specs::v1_6::attachment::Attachment>> = None;
...
pub(crate) mod test {
    ...
    use crate::{
        models,
        specs::v1_6::attachment::Attachment,
